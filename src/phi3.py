...
def main():
    ...
    shot_template = string.Template(
        "<|user|>\nBriefly summarize this dialogue: $dialogue <|end|>\n<|assistant|>$summary")
    oneshot_prompt = shot_template.substitute(
        dialogue=shot['dialogue'], summary=shot['summary']) + prompt
    ...
    shot_template = string.Template(
        "<|user|>\nBriefly summarize this dialogue: $dialogue <|end|>\n<|assistant|>$summary")
    twoshot_prompt = shot_template.substitute(
        dialogue=shot['dialogue'], summary=shot['summary']) + oneshot_prompt
